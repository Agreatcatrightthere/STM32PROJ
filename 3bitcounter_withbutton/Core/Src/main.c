...
int main(void)
{
  ...
  GPIO_PinState currbuttonstate =GPIO_PIN_RESET;
  /* USER CODE END 2 */
...
//	  }
	  currbuttonstate=HAL_GPIO_ReadPin(USER_Btn_GPIO_Port,USER_Btn_Pin);
	  if (currbuttonstate==GPIO_PIN_SET && lastbuttonstate ==GPIO_PIN_RESET)
	  {
		  HAL_Delay(50);
		  if (HAL_GPIO_ReadPin(USER_Btn_GPIO_Port,USER_Btn_Pin)==GPIO_PIN_SET)
			  {
